...
exp_lineup_home <- xpathSApply(exp_rawpage, '//div[@class="home_lineup"]//div[@class="dlineups-vplayer"]//a',xmlValue)
exp_lineup_away <- xpathSApply(exp_rawpage, '//div[@class="visit_lineup"]//div[@class="dlineups-vplayer"]//a',xmlValue)

# line up split per game 
line_ups_home <- matrix(exp_lineup_home, ncol = 11)
line_ups_away <- matrix(exp_lineup_away, ncol = 11)
